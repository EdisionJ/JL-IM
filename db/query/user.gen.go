...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.PassWd = field.NewString(tableName, "pass_wd")
	_user.Name = field.NewString(tableName, "name")
	_user.PhoneNumber = field.NewString(tableName, "phone_number")
	_user.Email = field.NewString(tableName, "email")
	_user.SelfDescribe = field.NewString(tableName, "self_describe")
	_user.LastOnlineTime = field.NewTime(tableName, "last_online_time")
...
type user struct {
	...
	Email          field.String
	SelfDescribe   field.String
	LastOnlineTime field.Time
	CreatAt        field.Time
	UpdateAt       field.Time
	DeleteAt       field.Time
...
func (u *user) updateTableName(table string) *user {
	...
	u.PassWd = field.NewString(table, "pass_wd")
	u.Name = field.NewString(table, "name")
	u.PhoneNumber = field.NewString(table, "phone_number")
	u.Email = field.NewString(table, "email")
	u.SelfDescribe = field.NewString(table, "self_describe")
	u.LastOnlineTime = field.NewTime(table, "last_online_time")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["self_describe"] = u.SelfDescribe
	u.fieldMap["last_online_time"] = u.LastOnlineTime
