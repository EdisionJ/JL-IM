...
func newRoom(db *gorm.DB, opts ...gen.DOOption) room {
	...
	_room.RoomID = field.NewInt64(tableName, "room_id")
	_room.UID = field.NewInt64(tableName, "uid")
	_room.Type = field.NewInt32(tableName, "type")
	_room.Nickname = field.NewString(tableName, "nickname")
	_room.Role = field.NewInt32(tableName, "role")
	_room.Ban = field.NewInt32(tableName, "ban")
	_room.JoinAt = field.NewTime(tableName, "join_at")
	_room.UpdateAt = field.NewTime(tableName, "update_at")
	_room.ExitAt = field.NewTime(tableName, "exit_at")
...
type room struct {
	...
	RoomID   field.Int64
	UID      field.Int64
	Type     field.Int32  // 0：私聊  1：群聊
	Nickname field.String // 聊天室内昵称
	Role     field.Int32  // -1：已退出 0：普通成员  1：管理员 2：群主
	Ban      field.Int32  // 0：正常发言 1：被禁言
	JoinAt   field.Time
	UpdateAt field.Time
	ExitAt   field.Time
...
func (r *room) updateTableName(table string) *room {
	...
	r.Role = field.NewInt32(table, "role")
	r.Ban = field.NewInt32(table, "ban")
	r.JoinAt = field.NewTime(table, "join_at")
	r.UpdateAt = field.NewTime(table, "update_at")
	r.ExitAt = field.NewTime(table, "exit_at")
...
func (r *room) fillFieldMap() {
	...
	r.fieldMap["ban"] = r.Ban
	r.fieldMap["join_at"] = r.JoinAt
	r.fieldMap["update_at"] = r.UpdateAt
	r.fieldMap["exit_at"] = r.ExitAt
}
